...
<@blog.blogHeader siteConfig.siteName,"","",""/>
    <div id="left-col">
	 <@blog.blogNav "home"/>
      <div id="content">
        <div class="page-nav"><#if ps?exists&&ps.pages?exists&&(ps.pages?size>0)><#if (ps.currentPage>1)><span class="previous-entries"><a href="<@blog.basePath/>index/${ps.currentPage-1}.html">Previous Entries</a></span><#else><span class="previous-entries"></span></#if><#if (ps.currentPage>0)&&(ps.currentPage<ps.totalPage)><span class="next-entries"><a href="<@blog.basePath/>index/${ps.currentPage+1}.html">Next Entries</a></span><#else><span class="next-entries"></span></#if></#if></div><!-- /page nav -->
