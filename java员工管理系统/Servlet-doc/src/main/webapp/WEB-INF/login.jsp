...
<link type="text/css" rel="stylesheet" media="all"
	href="./NETCTOSS_V02/styles/global.css" />
<link type="text/css" rel="stylesheet" media="all"
	href="./NETCTOSS_V02/styles/global_color.css" />
</head>
<body class="index">
	<form action="login.do" method="post" id="search_form">
		<div class="login_box">
			<table>
				<tr>
				...
				<tr>
					...
					<td class="login_button" colspan="2"><a
						href="javascript:document:search_form.submit();"><img
							src="./NETCTOSS_V02/images/login_btn.png" /></a></td>
