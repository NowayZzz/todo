    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteFee(id) {
                ...
                if(r){
                	window.location="deletefee.do?id="+id;
                }
            }
        </script>        
    </head>
        ...
        <div id="main">
            <form action="" method="">
                ...
                <div class="search_add">
                    ...
                    <input type="button" value="增加" class="btn_add" onclick="location.href='feeadd.do';" />
                </div> 
                <!--启用操作的操作提示-->
                ...
                <div id="data">            
                    <table id="datalist">
                       ...
                       <c:forEach items="${users}" var="u" >          
                        <tr>
                            <td>${u.id}</td>
                            <td><a href="fee_detail.html"></a>${u.name}</td>
                            <td>${u.base_duration}小时</td>
                            <td>${u.base_cost}元</td>
                            <td>${u.unit_cost}元/小时</td>
                            <td>${u.creatime}</td>
                            <td>${u.startime}</td>
                            <td>
                            <c:if test="${u.status=='0'}">暂停</c:if>
                            <c:if test="${u.status!='0'}">开通</c:if>
                            </td>
                            <td>                                
                                <input type="button" value="启用" class="btn_start" onclick="startFee();" />
                                <input type="button" value="修改" class="btn_modify" onclick="location.href='fee_modi.do?id=${u.id}';" />
